...
public class ScheduledPreProcessor extends BasePreProcessor implements DataPreProcessor {

 private static final Logger LOG = Logger
  .getLogger(ScheduledPreProcessor.class.getName());
 @Override
 public boolean execute(HashMap arg0, DataControllerRequest request, Result arg2) throws Exception {
  ...
  try {
   if (arg0.get("transferFlag") != null && !arg0.get("transferFlag").equals("scheduled")) {
    arg2.setParam(new Param("opstatus", "0", "String"));
    LOG.debug("In Scheduled before returning false");
    return false;
   }
  } catch (Exception e) {
   LOG.fatal(e);
