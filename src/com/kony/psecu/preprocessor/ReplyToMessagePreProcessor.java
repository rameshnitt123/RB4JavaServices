...
public class ReplyToMessagePreProcessor extends BasePreProcessor implements DataPreProcessor {

 private static final Logger LOG = Logger
  .getLogger(ReplyToMessagePreProcessor.class.getName());
 @Override
 public boolean execute(HashMap arg0, DataControllerRequest request, Result arg2) throws Exception {
  ...
  try {
   ...
   if (arg0.get("MessageFlag") != null && !arg0.get("MessageFlag").equals("replyToMessage")) {
