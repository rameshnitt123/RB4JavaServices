...
public class OTPforMFAPreProcessor extends BasePreProcessor implements DataPreProcessor {

	private static final Logger LOG = Logger.getLogger(OTPforMFAPreProcessor.class.getName());
	...
	public boolean execute(HashMap arg0, DataControllerRequest request, Result arg2) throws Exception {
		...
		try {
			if (arg0.get("rsaFlag") != null && !arg0.get("rsaFlag").equals("PhoneOTP")) {
