...
public class PayThirdPartyMemberPreProcessor extends BasePreProcessor implements DataPreProcessor {

 private static final Logger LOG = Logger
  .getLogger(PayThirdPartyMemberPreProcessor.class.getName());
 @Override
 public boolean execute(HashMap arg0, DataControllerRequest request, Result arg2) throws Exception {
  ...
  try {
   if (arg0.get("transactionCreateFlag") != null && !arg0.get("transactionCreateFlag").equals("payThirdPartyMember")) {
