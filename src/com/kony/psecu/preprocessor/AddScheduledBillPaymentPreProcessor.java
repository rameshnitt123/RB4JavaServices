...
public class AddScheduledBillPaymentPreProcessor extends BasePreProcessor implements DataPreProcessor {

 private static final Logger LOG = Logger
  .getLogger(AddScheduledBillPaymentPreProcessor.class.getName());
 @Override
 public boolean execute(HashMap arg0, DataControllerRequest request, Result arg2) throws Exception {
  ...
  try {
   if (arg0.get("PayeeCreateFlag") != null && !arg0.get("PayeeCreateFlag").equals("AddScheduledBillPayment")) {
