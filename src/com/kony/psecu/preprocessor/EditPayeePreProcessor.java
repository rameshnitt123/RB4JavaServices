...
public class EditPayeePreProcessor extends BasePreProcessor implements DataPreProcessor {

 private static final Logger LOG = Logger
  .getLogger(EditPayeePreProcessor.class.getName());
 @Override
 public boolean execute(HashMap arg0, DataControllerRequest request, Result arg2) throws Exception {
  ...
  try {
   if (arg0.get("PayeePartialUpdateFlag") != null && !arg0.get("PayeePartialUpdateFlag").equals("EditPayee")) {
