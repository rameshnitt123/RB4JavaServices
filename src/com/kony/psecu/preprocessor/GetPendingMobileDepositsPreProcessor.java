...
public class GetPendingMobileDepositsPreProcessor extends BasePreProcessor implements DataPreProcessor {

 private static final Logger LOG = Logger
  .getLogger(GetPendingMobileDepositsPreProcessor.class.getName());
 @Override
 public boolean execute(HashMap arg0, DataControllerRequest request, Result arg2) throws Exception {
  ...
  try {
   if (arg0.get("transferFlag") != null && !arg0.get("transferFlag").equals("getDeposits")) {
    ...
    LOG.debug("In PendingMobileDeposits before returning false");
    return false;
   }
  } catch (Exception e) {
   LOG.fatal(e);
