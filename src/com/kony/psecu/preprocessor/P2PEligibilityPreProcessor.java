...
public class P2PEligibilityPreProcessor extends BasePreProcessor implements DataPreProcessor {

 private static final Logger LOG = Logger
  .getLogger(P2PEligibilityPreProcessor.class.getName());
 @Override
 public boolean execute(HashMap arg0, DataControllerRequest request, Result arg2) throws Exception {
  ...
  try {
   if (arg0.get("userGetFlag") != null && !arg0.get("userGetFlag").equals("p2p")) {
