...
public class SendAppFeedbackPreProcessor extends BasePreProcessor implements DataPreProcessor {

 private static final Logger LOG = Logger
  .getLogger(SendAppFeedbackPreProcessor.class.getName());
 @Override
 public boolean execute(HashMap arg0, DataControllerRequest request, Result arg2) throws Exception {
  ...
  try {
   if (arg0.get("updateFlag") != null && !arg0.get("updateFlag").equals("appFeedback")) {
