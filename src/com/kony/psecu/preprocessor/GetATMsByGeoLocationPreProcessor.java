...
public class GetATMsByGeoLocationPreProcessor implements DataPreProcessor {

 private static final Logger LOG = Logger
  .getLogger(GetATMsByGeoLocationPreProcessor.class.getName());
 @Override
 public boolean execute(HashMap arg0, DataControllerRequest request, Result arg2) throws Exception {
  // TODO Auto-generated method stub	
  try {
   if (arg0.get("atmFlag") != null && !arg0.get("atmFlag").equals("geoLocation")) {
  ...
  LOG.debug("rsaDevice in ATM  geo before ----------------> " + (String) arg0.get("rsaDevice"));
  PSECUUtil utilObj = new PSECUUtil();
  String rsaDevice = (String) arg0.get("rsaDevice");
  arg0.put("rsaDevice", utilObj.modifyRSA(rsaDevice));
  LOG.debug("rsaDevice in ATM  geo after ----------------> " + (String) arg0.get("rsaDevice"));
  return true;
 }
