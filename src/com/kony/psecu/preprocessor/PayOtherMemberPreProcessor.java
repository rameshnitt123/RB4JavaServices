...
public class PayOtherMemberPreProcessor extends BasePreProcessor implements DataPreProcessor {

 private static final Logger LOG = Logger
  .getLogger(PayOtherMemberPreProcessor.class.getName());
 @Override
 public boolean execute(HashMap arg0, DataControllerRequest request, Result arg2) throws Exception {
  ...
  try {
   if (arg0.get("transactionCreateFlag") != null && !arg0.get("transactionCreateFlag").equals("payOtherMember")) {
