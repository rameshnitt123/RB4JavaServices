...
public class GetLOSRedirectionTokenPreProcessor extends BasePreProcessor implements DataPreProcessor {

 private static final Logger LOG = Logger
  .getLogger(GetLOSRedirectionTokenPreProcessor.class.getName());
 @Override
 public boolean execute(HashMap arg0, DataControllerRequest request, Result arg2) throws Exception {
  ...
  try {
   if (arg0.get("redirectionFlag") != null && !arg0.get("redirectionFlag").equals("loan")) {
