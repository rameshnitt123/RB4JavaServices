...
public class GetPayeecatogoriesPostProcessor implements DataPostProcessor {

 private static final Logger LOG = Logger
  .getLogger(GetPayeecatogoriesPostProcessor.class.getName());
 @Override
  ...
  try {
   if (results != null) {
    ...
    if (ds.size() == 0) {
     ...
     newDataSet.setId("payeeCategories");
